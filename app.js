...
// Player State Enhanced (مع الأوسمة والبكجات)
let defaultPlayer = {
  uid: '', email: '', name: 'زائر', 
...
// المالك لديه أموال غير محدودة في الواجهة
...
function renderGameUI() {
  ...
  // فحص الخسارة (إذا كانت كل الخانات ممتلئة ولكن الكلمة خاطئة)
...
async function openCrate(crateId) {
    ...
    setTimeout(async () => {
        ...
        if(!wonItem) wonItem = crate.drops[0]; // fallback
